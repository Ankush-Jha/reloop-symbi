            ...
            >
                ...
                {step === 2 && (
                    <motion.div variants={itemVariants} className="text-center">
                        ...
                        <button className="px-6 py-3 bg-white dark:bg-dark-surface border-2 border-dark dark:border-gray-600 rounded-full font-bold text-dark dark:text-white shadow-brutal-sm active:scale-95 transition-transform flex items-center gap-2 mx-auto">
